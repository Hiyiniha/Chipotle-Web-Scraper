...
In order to use this program, you must run the code on some sort of Mac laptop or computer. This code utilizes your Apple ID and iMessage to send the message with the promo code.
